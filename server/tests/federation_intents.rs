...
//! fixtures on disk are the five intents (the task handoff of #111 among
//! them) and the three responses.
...
#[test]
fn the_fixtures_are_the_five_intents_and_the_three_responses() {
